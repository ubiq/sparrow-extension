...
/**
 * Transaction Type is a Sparrow construct used internally
 *
 ...
 *  the token to spend on behalf of the user for the Sparrow Swaps contract. The first
...
/**
 * Transaction Status is a mix of Ethereum and Sparrow terminology, used internally
...
/**
 * Transaction Group Status is a Sparrow construct to track the status of groups
 * of transactions.
 *
...
/**
 * Transaction Group Category is a Sparrow construct to categorize the intent
 ...
 *  Sparrow Swaps. This transaction group's primary currency changes depending
 ...
 *  has been added to the user's Sparrow.
 * @property {'Transaction Approved'} APPROVED - When an unapproved transaction
 *  is in the controller state, Sparrow will render a confirmation screen for
 ...
 *  indicate that Sparrow is submitting a transaction at the user's request.
